      ...
      wayland.windowManager.hyprland = {
        ...
        settings = {
          ...
          workspace = [
            ...
            "name:bedroom, monitor:desc:Hisense Electric Co. Ltd. HISENSE 0x00000001, default:true, gapsout:35, persistent:true"
          ];
          windowrule = [
          ...
          bindl = [
            ...
            ", switch:off:Lid Switch, exec, hyprctl keyword monitor 'eDP-2, enable'"
          ];
          bindr = [
