...
let
  cfg = config.modules.graphical.desktop.hyprland;
in
{
  imports = [
    ./quickshell.nix
  ...
  options = {
    modules.graphical.desktop.hyprland.enable = lib.mkOption {
      type = lib.types.bool;
  ...
  config = lib.mkIf cfg.enable {
    # Enable wayland configs.
    modules.graphical.desktop = {
      compositor.wayland.enable = true;
      hyprland.quickshell.enable = true;
    };
    ...
    wayland.windowManager.hyprland = {
      ...
      settings = {
        ...
        monitor = [
          ...
          "desc:AOC Q27G3XMN 1APQAJA001629, 2560x1440@180, auto-right, 1"
          #"desc:AOC U34G2G4R3 0x000045A1, 3440x1440@144, 0x0, 1, bitdepth, 10, cm, hdr, sdrbrightness, 4, sdrsaturation, 1.5"
          #"desc:AOC U34G2G4R3 0x000045A1, 3440x1440@144, 0x0, 1, bitdepth, 10, cm, hdr, sdrbrightness, 1.4, sdrsaturation, 1.4"
